    ...
    export function Register() {
      ...
      const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          // Note: The handle_new_user trigger should create the profile automatically.
          // We might not need this explicit upsert unless the trigger fails or is disabled.
          // Keeping it for robustness, but ensure the trigger is the primary mechanism.
          const { error: profileError } = await supabase
            ...
            ], { onConflict: 'id' }); // Added onConflict to handle potential race conditions with trigger
          ...
          // Redirect to marketplace on successful registration
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      minLength={6} // Added minLength for Supabase password requirement
                      className="block w-full rounded-lg border border-gray-300 pl-10 pr-3 py-3 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500 focus:outline-none sm:text-sm"
